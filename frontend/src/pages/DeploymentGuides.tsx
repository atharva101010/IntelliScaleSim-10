        ...
        <div className="prose max-w-none">
            ...
            <div className="mb-8">
                <h3 className="text-xl font-semibold text-slate-800 mb-3 flex items-center">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-rose-100 text-rose-600 font-bold text-sm mr-3">1</span>
            ...
            <div className="mb-8">
                <h3 className="text-xl font-semibold text-slate-800 mb-3 flex items-center">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-rose-100 text-rose-600 font-bold text-sm mr-3">2</span>
            ...
            <div className="mb-8">
                <h3 className="text-xl font-semibold text-slate-800 mb-3 flex items-center">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-rose-100 text-rose-600 font-bold text-sm mr-3">3</span>
            ...
            <div className="mb-8">
                <h3 className="text-xl font-semibold text-slate-800 mb-3 flex items-center">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-rose-100 text-rose-600 font-bold text-sm mr-3">4</span>
            ...
            <div className="mb-8">
                <h3 className="text-xl font-semibold text-slate-800 mb-3 flex items-center">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-rose-100 text-rose-600 font-bold text-sm mr-3">5</span>
                    Deploy Container
                </h3>
            ...
            <div className="mb-8">
                ...
                <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                    ...
                    <div className="space-y-2 text-slate-700">
                        ...
                        <p className="text-sm text-amber-800 mt-3">⚠️ Save your token securely - you won't  see it again!</p>
                    </div>
                </div>
            </div>
